...
import ListBookCardDrawer from "@/components/ListBookCardDrawer.tsx";


const ListBookCard: React.FC<{ book: TrendingModel, listId: number, isOwner: boolean, onRemoveBook: () => void }> = ({ book, listId, isOwner, onRemoveBook }  ) => {
            ...
            <div className="flex gap-6 items-stretch">
                ...
                <div className="flex flex-col justify-center pr-6 py-4 space-y-3">
                    <div className="flex items-center justify-between w-full">
                        ...
                        >{book.title}</Link>
                        <ListBookCardDrawer listId={listId} bookId={book.id} isOwner={isOwner} onRemoveBook={onRemoveBook}/>
                    </div>
                    <div>
